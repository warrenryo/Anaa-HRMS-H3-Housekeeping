            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0" x-data="{ activeDropdown: null }">
                ...
                <li class="nav-item">
                    <ul>
                        ...
                        <li class="nav-item @if(request()->is('HousekeepingAdmin/housekeeper-reports')) bg-[#000]/[0.08] text-black dark:bg-[#181f32] rounded-md dark:text-white-dark @endif">
                            <a href=" {{ url('HousekeepingAdmin/housekeeper-reports') }}" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">View Reports</span>
                                </div>
                            </a>
                        </li>
                    </ul>
