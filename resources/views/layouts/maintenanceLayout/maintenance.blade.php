...
<body x-data="main" class="antialiased relative font-nunito text-sm font-normal overflow-x-hidden"
    ...
    @php
        ...
        $user = App\Models\User::find($auth);
        
    @endphp

    <div class="main-container text-black dark:text-white-dark min-h-screen" :class="[$store.app.navbar]">

        @include('layouts.maintenanceLayout.maintenanceLayoutComponents.sidebar')

        <div class="main-content">
            @include('layouts.maintenanceLayout.maintenanceLayoutComponents.header')

      

            <div class="p-6 animate__animated" :class="[$store.app.animation]">
                @yield('content')
                @include('layouts.maintenanceLayout.maintenanceLayoutComponents.footer')
            </div>
