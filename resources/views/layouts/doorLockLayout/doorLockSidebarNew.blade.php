<aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
    class="absolute left-0 top-0 z-20 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black2 duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0"
        ...
        <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6" x-data="{selected: $persist('Dashboard')}">
            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    <!-- Menu Item Dashboard -->
                    <li>
                        <a class="@if(request()->is('doorLock-admin/dashboard')) bg-[#333A48] dark:bg-meta-4 @endif group relative flex items-center gap-2.5 rounded-sm px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#333A48] dark:hover:bg-meta-4"
                            href="{{ url('doorLock-admin/dashboard') }}"
                            @click="selected = (selected === 'Calendar' ? '':'Calendar')"
                            :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Calendar') && (page === 'calendar') }">
                            <span class="hover:translate-x-6 flex items-center pr-30 py-2 duration-300">
                                <svg class="fill-current mr-2" width="18" height="18" viewBox="0 0 18 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <h3 class="mb-4 mt-4 ml-4 text-sm font-medium text-bodydark2">ROOM & DOOR KEYS</h3>
                    <li>
                        <a class="@if(request()->is('doorLock-admin/door-key-lists')) bg-[#333A48] dark:bg-meta-4 @endif group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#333A48] dark:hover:bg-meta-4"
                            href="{{ url('doorLock-admin/door-key-lists') }}"
                            @click="selected = (selected === 'Calendar' ? '':'Calendar')"
                            :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Calendar') && (page === 'calendar') }">
                            <div class="hover:translate-x-6 flex items-center  pr-28 duration-300">
                                <i class="lni lni-key mr-2"></i>
            ...
            <!-- Others Group -->
            <div>
                <h3 class="mb-4 ml-4 text-sm font-medium text-bodydark2">DOOR ACTIVITY LOGS</h3>

                <ul class="mb-6 flex flex-col gap-1.5">
                    <!-- Menu Item Chart -->
                    <li>
                        <a class="@if(request()->is('doorLock-admin/door-logs')) bg-[#333A48] dark:bg-meta-4 @endif group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#333A48] dark:hover:bg-meta-4"
                            href="{{ url('doorLock-admin/door-logs') }}"
                            @click="selected = (selected === 'Chart' ? '':'Chart')"
                            :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Chart') && (page === 'Chart') }">
                            <div class="hover:translate-x-6 flex items-center  pr-28 duration-300">
                                <i class="lni lni-files mr-2"></i>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <li>
                        <a href="{{ route('profile.edit') }}"
                            ...
                            <div class="hover:translate-x-6 flex items-center  pr-12 duration-300">
                                <svg class="fill-current mr-2" width="22" height="22" viewBox="0 0 22 22" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <li>
                        <a href="{{ url('modules') }}"
                            class="@if(request()->is('profile.edit')) bg-[#333A48] dark:bg-meta-4 @endif group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-[#333A48] dark:hover:bg-meta-4">
                            <div class="hover:translate-x-6 flex items-center  pr-30 duration-300">
                                <svg class="fill-current mr-2" width="18" height="18" viewBox="0 0 18 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
