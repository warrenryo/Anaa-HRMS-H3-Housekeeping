        ...
        <div class="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-[#0e1726]">
            <div class="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                <a href="/" class="main-logo flex items-center shrink-0">
                    <img class="w-20 ltr:-ml-1 rtl:-mr-1 inline" src="{{ url('img/anaa_logs.png') }}" alt="image" />
                    <span
                ...
                <div class="dropdown" x-data="dropdown" @click.outside="open = false">
                    ...
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                        ...
                        <div class="overflow-y-auto h-[50vh] ">
                            ...
                            <li class=" dark:text-white-light/90 border-b ">
                                <div class="flex items-center px-4 py-2 group" @click.self="toggle">
                                    ...
                                    <a href="{{ url('housekeeper/markUnread'.$notification->id) }}"
                                        class="ltr:pl-3 rtl:pr-3 flex flex-auto">
                                        <div class="ltr:pr-3 rtl:pl-3">
                                            <h6><span class="text-sm mr-1">You have new Housekeeping task on <strong>Room {{$notification->data['room_no']}} </strong></span> scheduled at <strong>{{
                                                    \Carbon\Carbon::parse($notification->data['time_issue'])->format('g:i
                                                    A')}}</strong></h6>
                                            <span
                                                class="text-xs block font-normal dark:text-gray-500">{{$notification->created_at->diffForHumans()}}
                                                <span
                                                    class="inline-flex text-[10px] rounded-full bg-success bg-opacity-10 px-3 py-1 text-success dark:bg-green-200">New</span></span>
                                        </div>
                                        <button type="button"
                                ...
                                <div class="flex items-center px-4 py-2 group" @click.self="toggle">
                                    <a href="{{ url('housekeeper/markUnread'.$notification->id) }}"
                                        ...
                                        <h6><span class="text-sm mr-1">You have new Housekeeping task on <strong>Room {{$notification->data['room_no']}} </strong></span> scheduled at <strong>{{
                                                    ...
                                                    A')}}</strong></h6>
                                            <span
                                                class="flex items-center gap-2 text-xs block font-normal dark:text-gray-500">{{$notification->created_at->diffForHumans()}}
                                                <span
                        ...
                        <div>
                            <li>
                                <div class="p-4">
                                    <a href="{{ url('markAsAllRead') }}"
                                        class="btn btn-primary block w-full btn-small text-center">Read All
                                        Notifications</a>
                                </div>
                            </li>
                        </div>
