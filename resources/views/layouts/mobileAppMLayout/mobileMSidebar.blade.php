    ...
    <nav x-data="sidebar" class="sidebar fixed min-h-screen h-full top-0 bottom-0 w-[260px] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] z-50 transition-all duration-300">
        <div class="bg-white dark:bg-[#0e1726] h-full">
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0" x-data="{ activeDropdown: null }">
                ...
                <li class="nav-item">
                    <ul>
                        <li class="nav-item @if(request()->is('maintenance/work-order-maintenance')) bg-[#000]/[0.08] text-black dark:bg-[#181f32] rounded-md dark:text-white-dark @endif">
                            <a href=" {{ url('maintenance/work-order-maintenance') }}" class="group">
                                <div class="flex items-center">
                        ...
                        <li class="nav-item @if(request()->is('maintenance/completed-task-m')) bg-[#000]/[0.08] text-black dark:bg-[#181f32] rounded-md dark:text-white-dark @endif">
                            <a href="{{ url('maintenance/completed-task-m') }}" class="group">
                                <div class="flex items-center">
