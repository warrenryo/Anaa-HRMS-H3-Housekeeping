            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0" x-data="{ activeDropdown: null }">
                ...
                <li class="nav-item">
                    <ul>
                        ...
                        <li class="nav-item">
                            <a href="{{ url('housekeeper/create-report') }}" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Create Report</span>
                                </div>
                            </a>
                        </li>
