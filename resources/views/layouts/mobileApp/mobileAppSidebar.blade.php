    ...
    <nav x-data="sidebar" class="sidebar fixed min-h-screen h-full top-0 bottom-0 w-[260px] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] z-50 transition-all duration-300">
        <div class="bg-white dark:bg-[#0e1726] h-full">
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0" x-data="{ activeDropdown: null }">
                <li class="nav-item @if(request()->is('housekeeper/dashboard')) bg-[#000]/[0.08] text-black dark:bg-[#181f32] rounded-md dark:text-white-dark @endif">
                    <a href="{{ url('housekeeper/dashboard') }}" class="group">
                ...
                <li class="nav-item">
                    <ul>
                        <li class="nav-item @if(request()->is('housekeeper/work-order')) bg-[#000]/[0.08] text-black dark:bg-[#181f32] rounded-md dark:text-white-dark @endif">
                            <a href=" {{ url('housekeeper/work-order') }}" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Work Orders</span>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item @if(request()->is('housekeeper/completed-task')) bg-[#000]/[0.08] text-black dark:bg-[#181f32] rounded-md dark:text-white-dark @endif">
                            <a href="{{ url('housekeeper/completed-task') }}" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Completed Task</span>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="/apps/notes" class="group">
                                <div class="flex items-center">
                                    ...
                                    <svg class="group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.5" d="M3 10C3 6.22876 3 4.34315 4.17157 3.17157C5.34315 2 7.22876 2 11 2H13C16.7712 2 18.6569 2 19.8284 3.17157C21 4.34315 21 6.22876 21 10V14C21 17.7712 21 19.6569 19.8284 20.8284C18.6569 22 16.7712 22 13 22H11C7.22876 22 5.34315 22 4.17157 20.8284C3 19.6569 3 17.7712 3 14V10Z" fill="#9C603B" />
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M7.25 12C7.25 11.5858 7.58579 11.25 8 11.25H16C16.4142 11.25 16.75 11.5858 16.75 12C16.75 12.4142 16.4142 12.75 16 12.75H8C7.58579 12.75 7.25 12.4142 7.25 12Z" fill="#9C603B" />
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M7.25 8C7.25 7.58579 7.58579 7.25 8 7.25H16C16.4142 7.25 16.75 7.58579 16.75 8C16.75 8.41421 16.4142 8.75 16 8.75H8C7.58579 8.75 7.25 8.41421 7.25 8Z" fill="#9C603B" />
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M7.25 16C7.25 15.5858 7.58579 15.25 8 15.25H13C13.4142 15.25 13.75 15.5858 13.75 16C13.75 16.4142 13.4142 16.75 13 16.75H8C7.58579 16.75 7.25 16.4142 7.25 16Z" fill="#9C603B" />
                                    </svg>
