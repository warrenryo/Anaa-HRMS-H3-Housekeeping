            ...
            <div class="panel p-4 flex-none  w-[240px] absolute xl:relative z-10 space-y-4 h-full xl:h-auto hidden xl:block ltr:lg:rounded-r-md ltr:rounded-r-none rtl:lg:rounded-l-md rtl:rounded-l-none overflow-hidden" :class="{ 'hidden shadow': !isShowNoteMenu, 'h-full ltr:left-0 rtl:right-0': isShowNoteMenu }">
                <div class="flex flex-col h-full ">
                    ...
                    <div class="perfect-scrollbar relative pr-3.5 -mr-3.5 h-full grow">
                        <div class="space-y-1">
                            <a href="{{ url('maintenance/work-order') }}" class=" w-full flex justify-between items-center p-2 hover:bg-white-dark/10 rounded-md dark:hover:text-primary hover:text-primary dark:hover:bg-[#181F32] font-medium h-10" :class="{
                            ...
                            <form action="" method="GET" id="filterForm">
                                <label for="pending_radio" onclick="submitForm()" class="@if(Request::get('filter_status') == 'Pending') bg-white-dark/10 dark:bg-[#181F32] ltr:pl-3 rtl:pr-3 @endif w-full cursor-pointer flex items-center h-10 p-1 hover:bg-white-dark/10 rounded-md dark:hover:bg-[#181F32] font-medium text-warning ltr:hover:pl-3 rtl:hover:pr-3 duration-300">
                                    <input id="pending_radio" type="radio" name="filter_status" value="Pending" class="hidden form-radio outline-warning peer" />
                                ...
                                <label for="in-progress" onclick="submitForm()" class="@if(Request::get('filter_status') == 'In-Progress') bg-white-dark/10 dark:bg-[#181F32] ltr:pl-3 rtl:pr-3 @endif w-full cursor-pointer flex items-center h-10 p-1 hover:bg-white-dark/10 rounded-md dark:hover:bg-[#181F32] font-medium text-primary ltr:hover:pl-3 rtl:hover:pr-3 duration-300">
                                    <input id="in-progress" type="radio" name="filter_status" value="In-Progress" class="hidden form-radio outline-success peer" />
                                ...
                                <!--<label for="completed_radio" onclick="submitForm()" class="@if(Request::get('filter_status') == 'Completed') bg-white-dark/10 dark:bg-[#181F32] ltr:pl-3 rtl:pr-3 @endif w-full cursor-pointer flex items-center h-10 p-1 hover:bg-white-dark/10 rounded-md dark:hover:bg-[#181F32] font-medium text-success ltr:hover:pl-3 rtl:hover:pr-3 duration-300">
                                    <input id="completed_radio" type="radio" name="filter_status" value="Completed" class="hidden form-radio outline-success peer" />
                        ...
                        <div data-hs-overlay="#view-details{{$task->id}}" class="panel @if($task->h3_status == 'Pending') bg-warning-light shadow-warning @elseif($task->h3_status == 'In-Progress') bg-primary-light shadow-primary @else bg-success-light shadow-success @endif pb-12">
                            <div class="min-h-[142px]">
                                <div class="flex justify-between">
                                    <div class="flex items-center space-x-2">
                                        <div class="">
                                            <div class="font-semibold">{{$task->h3_maintenance_staff_name}}</div>
                            ...
                            <div class="absolute bottom-5 left-0 w-full px-5">
                                <div class="flex items-center justify-between mt-2">
                                    <div class="@if($task->h3_status == 'Pending') text-warning  @else text-success @endif">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 rotate-45 @if($task->h3_status == 'Pending') fill-warning  @elseif($task->h3_status == 'In-Progress') fill-primary @else fill-success @endif">
                                            <path d="M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12Z" stroke="currentColor">
                                            </path>
                                        </svg>
                                    </div>
