            ...
            <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto min-h-[calc(100%-3.5rem)] flex items-center justify-center">
                <div class="flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                    ...
                    <div class="p-4 overflow-y-auto">
                        <form action="{{ url('inventory-admin/submit-maintenance-category') }}" method="POST">
                            @csrf
                            <div>
                                <label for="category">Maintenance Category</label>
                                <input id="category" name="m_category" type="text" placeholder="Enter Category" class="form-input" required />
                            </div>
                    </div>
...
<!--DATA TABLE FOR CATEGORY-->
        <div class="table-responsive mt-4">
            <table class="table-hover">
                <thead>
                    <tr>
                        <th class="text-xs">ID</th>
                        <th class="text-xs">MAINTENANCE CATEGORY</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="whitespace-nowrap">
                            {{$category->h3_m_category}}
                        </td>
                        <td class="flex ">
                            @include('inventoryAdmin.maintenanceCategory.maintenanceCategoryModal')
