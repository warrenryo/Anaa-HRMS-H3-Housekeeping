        ...
        <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
            <div class="panel h-full">
                ...
                <div>
                    ...
                    <div class="w-full absolute bottom-0 flex items-center justify-between p-5 -mx-5">
                        ...
                        <a href="javascript:;" class="flex items-center bg-success/30 text-success rounded-md px-1.5 py-1 text-xs hover:shadow-[0_10px_20px_-10px] hover:shadow-success">Read
                            More
            ...
            <div class="panel h-full">
                ...
                <div class="font-semibold text-center pb-8">
                    ...
                    <div class="w-full absolute bottom-0 flex items-center justify-between p-5 -mx-5">
                        <a href="javascript:;" class="btn btn-secondary btn-lg w-full border-0 bg-gradient-to-r from-[#3d38e1] to-[#1e9afe]">View
                            Details</a>
                    </div>
                </div>
            </div>
...
<script>
    var h_inventory = {!!$h_inventory!!};

    const items = [];
    const quantity = [];
    h_inventory.forEach(function(val) {
