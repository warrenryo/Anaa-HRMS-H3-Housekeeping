                                ...
                                <div class="flex gap-x-4 md:gap-x-7">
                                    ...
                                    <div class="grow">
                                        ...
                                        <p class="text-gray-500">
                                            Permanently remove Exceeded Requests and all of its contents from the ANAA HOTEL MAINTENANCE. This action is not reversible, so please continue with caution.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endphp
                                    @if($request->h3_status == 'Work Order Created')
                                    <div class="py-2">
                                ...
                                <td>
                                    @include('MaintenanceAdmin.maintenanceRequest.maintenanceRequestModal')
                                    ...
                                    <a href="{{url('maintenance-admin/create-maintenance-order/request-code='.$request->h3_request_code)}}" class="hs-tooltip inline-block [--trigger:hover]">
