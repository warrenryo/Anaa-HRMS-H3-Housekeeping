...
<div class="relative overflow-hidden">
    ...
    <div class="max-w-[85rem] relative top-10 z-99 px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <!-- Grid -->
        <div class="grid md:grid-cols-2 items-center gap-20">
            <div class="relative mb-4 md:mb-0">
                ...
                <div class="flex panel flex-col border rounded-xl p-4 sm:p-6 lg:p-10 dark:border-gray-700">
                    ...
                    <form action="{{ url('submit-maintenance-request') }}" method="POST" id="form">
                        @csrf
                        <div class="mt-6 grid gap-4 lg:gap-6">
                            <!-- Grid -->
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                                <div>
                                    <label for="room_no" class="block mb-2 text-sm text-gray-700 font-medium dark:text-white">Room</label>
                                    <select id="room_no" name="room_no" required class="form-select form-select-lg text-white-dark">
                                ...
                                <div>
                                    ...
                                    <input name="time_issue" value="{{ now()->format('H:i') }}" class="dark:border-[#17263c] dark:bg-[#121e32] dark:text-white-dark dark:focus:border-primary border-gray-300 rounded-md py-2.5 focus:border-primary" type="time">
                                </div>
                            </div>
                            <!-- End Grid -->
                            ...
                            <div>
                                <div class=" ">
                                    <label for="hs-work-email-hire-us-1" class="block mb-2 text-sm text-gray-700 font-medium dark:text-white">Here are some Maintenance you might want to Request</label>
                                    <div class="grid grid-cols-2">

                                        <label class="inline-flex mt-4">
                                            <input type="checkbox" name="maintenance_request[]" value="Air Conditioning Sytem" class="form-checkbox text-info rounded-full peer" />
                                            <span class="peer-checked:text-info dark:text-gray-400 text-sm font-medium">Air Conditioning Sytem</span>
                                        </label>
                                        <label class="inline-flex mt-4">
                                            <input type="checkbox" name="maintenance_request[]" value="Plumbing Issues" class="form-checkbox text-info rounded-full peer" />
                                            <span class="peer-checked:text-info dark:text-gray-400 text-sm font-medium">Plumbing Issues</span>
                                        </label>
                                        <label class="inline-flex mt-4">
                                            <input type="checkbox" name="maintenance_request[]" value="Electrical Problems" class="form-checkbox text-info rounded-full peer" />
                                            <span class="peer-checked:text-info dark:text-gray-400 text-sm font-medium">Electrical Problems</span>
                                        </label>
                                        <label class="inline-flex mt-4">
                                            <input type="checkbox" name="maintenance_request[]" value="Room Appliances Issues" class="form-checkbox text-info rounded-full peer" />
                                            <span class="peer-checked:text-info dark:text-gray-400 text-sm font-medium">Room Appliances Issues</span>
                                        </label>
                                        <label class="inline-flex mt-4">
                                            <input type="checkbox" name="maintenance_request[]" value="Door and Window Issues" class="form-checkbox text-info rounded-full peer" />
                                            <span class="peer-checked:text-info dark:text-gray-400 text-sm font-medium">Door and Window Issues</span>
                                        </label>
                                    </div>
                            ...
                            <div>
                                ...
                                <textarea placeholder="Specify your Requests here" id="additional" name="additional_request" rows="4" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"></textarea>
                            </div>
                            <div>
                                <p id="errorMsg2" class="text-danger text-sm hidden relative bottom-2">* Please specify your request so that we can know the specific issues.</p>
                            </div>
                        </div>
                        <!-- End Grid -->
            ...
            <!-- End Col -->
            <div>
                <h1 class="text-3xl font-bold text-white-light sm:text-4xl lg:text-5xl lg:leading-tight dark:text-white">
                    Maintenance Request
                </h1>
                <p class="mt-1 md:text-lg text-gray-800 dark:text-gray-200">
                    We handle maintenance requests with expertise and care. Our team is dedicated to resolving issues promptly and efficiently. Whether it's a faulty appliance, a leaky faucet, or any other concern, we focus on details to ensure your space remains in top-notch condition. We go beyond fixing – we create a hassle-free environment, making your stay comfortable and worry-free.
                </p>
